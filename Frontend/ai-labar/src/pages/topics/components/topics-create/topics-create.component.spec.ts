...
describe('TopicsCreateComponent', () => {
  ...
  it('should call createTopics and navigate when validacionValores is true', () => {
    // Arrange
  ...
  it('should not call createTopics when validacionValores is false', () => {
    // Arrange
    spyOn(component, 'validacionValores').and.returnValue(false);
